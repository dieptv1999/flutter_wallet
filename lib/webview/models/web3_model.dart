...
class Web3Model extends ChangeNotifier {
  ...
  void updateWithValue(Web3Model web3Model) {
    tabIndex = web3Model.tabIndex;
    url = web3Model.url;
    title = web3Model.title;
    favicon = web3Model.favicon;
    progress = web3Model.progress;
    loaded = web3Model.loaded;
    isDesktopMode = web3Model.isDesktopMode;
    isIncognitoMode = web3Model.isIncognitoMode;
    setJavaScriptConsoleResults(web3Model._javaScriptConsoleResults.toList());
    setJavaScriptConsoleHistory(web3Model._javaScriptConsoleHistory.toList());
    setLoadedResources(web3Model._loadedResources.toList());
    isSecure = web3Model.isSecure;
    options = web3Model.options;
    webViewController = web3Model.webViewController;
  }

  static Web3Model? fromMap(Map<String, dynamic>? map) {
    return map != null ? Web3Model(
